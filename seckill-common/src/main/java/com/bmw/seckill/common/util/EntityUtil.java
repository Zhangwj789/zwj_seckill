...
public class EntityUtil {
    ...
    private final String moduleName = "seckill_case"; // 数据库名称

    private final String bean_path = "F:\\zwj\\java\\AAAshixun\\seckill-parent\\seckill-service\\src\\main\\java";

    private final String mapper_path = "F:\\zwj\\java\\AAAshixun\\seckill-parent\\seckill-service\\src\\main\\java\\com\\bmw\\seckill\\dao";

    private final String xml_path = "F:\\zwj\\java\\AAAshixun\\seckill-parent\\seckill-service\\src\\main\\resources\\mapping";// xml路径
    ...
    private final String password = "root";// "root";//数据库密码

    private final String url = "jdbc:mysql://127.0.0.1:3306/" + moduleName + "?characterEncoding=utf8&serverTimezone = GMT";
